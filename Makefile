...
pluginsGateway: # Copy plugins to Gateway
	...
	@cp -fr gravitee-am-identityprovider/gravitee-am-identityprovider-azure-ad/target/gravitee-am-identityprovider-google-$(GIO_AM_VERSION).zip $(GIO_AM_GATEWAY_PLUGINS)
...
pluginsManagement: # Copy plugins to Management API
	...
	@cp -fr gravitee-am-identityprovider/gravitee-am-identityprovider-azure-ad/target/gravitee-am-identityprovider-google-$(GIO_AM_VERSION).zip $(GIO_AM_MANAGEMENT_API_PLUGINS)
